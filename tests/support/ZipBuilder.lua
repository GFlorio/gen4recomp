...
function ZipBuilder.build(files)
  ...
  for _, f in ipairs(files) do
    ...
    local size = #f.data
    local localHeader = u32(0x04034b50) .. u16(20) .. u16(0) .. u16(0)
      .. u16(0) .. u16(0) .. u32(crc) .. u32(size) .. u32(size)
      .. u16(#f.name) .. u16(0) .. f.name
    locals[#locals + 1] = localHeader .. f.data

    central[#central + 1] = u32(0x02014b50) .. u16(20) .. u16(20) .. u16(0)
      .. u16(0) .. u16(0) .. u16(0) .. u32(crc) .. u32(size) .. u32(size)
      .. u16(#f.name) .. u16(0) .. u16(0) .. u16(0) .. u16(0) .. u32(0)
      .. u32(offset) .. f.name
  ...
  local eocd = u32(0x06054b50) .. u16(0) .. u16(0) .. u16(#files) .. u16(#files)
