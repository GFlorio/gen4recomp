...
function T.indexes_a_root_whose_path_contains_an_apostrophe()
  local baseDirectory = "/tmp/g4recomp-runner-files-test"
  ...
  sh('rm -rf "' .. baseDirectory .. '"')
  sh('mkdir -p "' .. baseDirectory .. "/" .. root .. '"')
  local path = baseDirectory .. "/" .. root .. "/quoted_suite_test.lua"
