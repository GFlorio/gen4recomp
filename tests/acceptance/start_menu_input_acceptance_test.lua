...
function T.tests.production_input_pipeline_carries_the_semantic_menu_button_and_its_required_binding()
  ...
  local game = harness:boot({ versionId = "heartgold", map = "MAP_NEW_BARK_ELMS_LAB_1F", save = "fresh" })
  ...
  local bootOk, bootErr = pcall(function()
    game2 = harness:boot({ versionId = "heartgold", map = "MAP_NEW_BARK_ELMS_LAB_1F", save = "fresh" })
  end)
