...
-- display name, expected size, and cache namespace. Full SHA-1 is authoritative;
-- size and game code are friendly sanity checks only. Pure domain module.
...
function GameVersion.cachePrefix(versionId)
  local info = GameVersion.info(versionId)
  return info and info.cachePrefix or nil
end
