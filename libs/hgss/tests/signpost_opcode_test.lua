...
local WaitSignpostActionTask = require("libs.hgss.src.script.tasks.WaitSignpostActionTask")
local TrainerTipsTask = require("libs.hgss.src.script.tasks.TrainerTipsTask")
local WaitSignpostTask = require("libs.hgss.src.script.tasks.WaitSignpostTask")
local SignTask = require("libs.hgss.src.script.tasks.SignTask")
...
local function harness()
  ...
  local taskRegistry = require("libs.script.src.TaskRegistry").new()
