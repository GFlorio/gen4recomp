...
-- readiness walk rejects a staged write. Runtime audio errors live in
-- libs/engine/src/audio/AudioErrors.lua; this module is the asset-side home
-- only. Pure domain module.
