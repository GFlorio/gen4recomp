...
-- (VertexFormat). MeshWriter and SceneMesh consume the binary layout; this
-- module only owns the numbers, so a format change touches one place. Pure
-- data, safe to require from the pure domain layers.
