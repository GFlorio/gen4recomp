-- Runtime audio errors are owned by the engine audio errors module, not the
-- field catalogue: provider resolution, player interpretation, and
-- music-service availability raise exactly these shared constants.
...
local function audioErrors()
  return require("libs.engine.src.audio.AudioErrors")
end
...
function T.runtime_audio_codes_are_owned_here()
  ...
  local codes = {
    ...
    "AUDIO_PLAYER_BANK_MISMATCH",
    "AUDIO_PLAYER_UNSUPPORTED_AMOUNT",
    "AUDIO_PLAYER_UNSUPPORTED_OP",
