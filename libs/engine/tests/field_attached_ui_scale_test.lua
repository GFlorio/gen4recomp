...
function T.field_exact_scale_keeps_the_dialogue_bottom_aligned()
  ...
  local layout = DialoguePresentationLayout.compute(ref, { scale = 2, cursorPlacement = CURSOR_PLACEMENT })
...
function T.field_presentation_is_centered_in_translated_reference_frames()
  ...
  local layout = DialoguePresentationLayout.compute(ref, { scale = 1.5, cursorPlacement = CURSOR_PLACEMENT })
