...
---@field getAt fun(self: FieldActorManagerTest.Manager, mapId: integer, candidate: table): table?
---@field isOccupied fun(self: FieldActorManagerTest.Manager, mapId: integer, candidate: table, except: string?): boolean
