  ...
  steps = {
    {
      ...
      op = "say",
      provenance = { offsets = { [1] = 4180 }, opcodes = { [1] = 729 } },
    },
    {
      condition = {
        condition = "compare",
      ...
      op = "goto_if",
      provenance = { offsets = { [1] = 4184, [2] = 4190 }, opcodes = { [1] = 17, [2] = 28 } },
      target = "_1078",
    },
    {
      message = "msg.project.placeholder",
      op = "say",
      provenance = { offsets = { [1] = 4197 }, opcodes = { [1] = 596 } },
    },
    {
      condition = {
        condition = "compare",
      ...
      op = "goto_if",
      provenance = { offsets = { [1] = 4201, [2] = 4207 }, opcodes = { [1] = 17, [2] = 28 } },
      target = "_1078",
    },
    {
      message = "msg.project.placeholder",
      op = "say",
      provenance = { offsets = { [1] = 4214 }, opcodes = { [1] = 600 } },
    },
    { name = "_1078", op = "label" },
    {
      op = "play_sound",
      provenance = { offsets = { [1] = 4216 }, opcodes = { [1] = 73 } },
    ...
    },
    {
      ...
      kind = 6,
      op = "fade_screen",
      provenance = { offsets = { [1] = 4220 }, opcodes = { [1] = 174 } },
      speed = 1,
    },
    { op = "wait_fade", provenance = { offsets = { [1] = 4230 }, opcodes = { [1] = 175 } } },
    {
      ...
      map = "MAP_T20R0102",
      op = "warp",
      provenance = { offsets = { [1] = 4232 }, opcodes = { [1] = 176 } },
      warp = 0,
    },
    {
      color = "black",
      ...
      kind = 6,
      op = "fade_screen",
      provenance = { offsets = { [1] = 4244 }, opcodes = { [1] = 174 } },
      speed = 1,
    },
    { op = "wait_fade", provenance = { offsets = { [1] = 4254 }, opcodes = { [1] = 175 } } },
    {
      op = "wait_sound",
      provenance = { offsets = { [1] = 4256 }, opcodes = { [1] = 75 } },
      sound = "SEQ_SE_DP_KAIDAN2",
    },
    {
      message = "msg.project.placeholder",
      op = "say",
      provenance = { offsets = { [1] = 4260 }, opcodes = { [1] = 582 } },
    },
    {
      op = "set_var",
      provenance = { offsets = { [1] = 4268 }, opcodes = { [1] = 41 } },
      value = 1,
      variable = { id = "VAR_UNK_407C", value = "var" },
    },
