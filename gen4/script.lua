-- Public gen4 field-script DSL, API 1. This stable forwarding module is the
...
-- directory layout. The compatibility surface (constructor shapes, operation
-- names, field names, defaults) is frozen by libs/engine/tests/script.
