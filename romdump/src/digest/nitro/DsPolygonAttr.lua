...
-- The effective value drawn for a shape is the field-global default masked with
-- the material's owned bits (see DsMaterial.resolve); this module only unpacks a
